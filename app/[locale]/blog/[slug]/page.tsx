/**
 * Blog post detail page — shares the same content as resources/[slug]
 * Blog slugs are the same as resource slugs but accessed via /blog/[slug]
 */
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const schemas = [
    ...
    breadcrumbSchema([
      ...
      { name: resource.title, url: absoluteUrl(`/${locale}/blog/${slug}`) },
    ]),
  ]
  ...
  return (
    <>
      ...
      <CtaSection
        title="Start Automating Your Customer Service Emails"
        subtitle="Join businesses saving hours every week with AI-powered email drafts and Telegram approval."
